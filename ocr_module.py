...
class GeminiThaiDocumentOCR:
    ...
    STEP 1: อ่านข้อความทั้งหมดในภาพ
    STEP 2: ตรวจสอบทุกคำที่มีสระ "า" ตามด้วย "ม" 
    STEP 3: ถามตัวเองว่า "ควรเป็นสระ ำ หรือไม่?"
    STEP 4: แก้ไขให้ถูกต้อง
    ...
    **ส่งคืนเฉพาะข้อความ ห้ามมีคำอธิบาย**"""
    ...
    def post_process_thai_document(self, text):
        ...
        sara_am_fixes = {
            ...
            # กลุ่ม "ป"
            'ปานกลาง': 'ปานกลาง',  # นี่ถูกต้องแล้ว
            
            # กลุ่ม "ผ"
            'ผาเสื้อ': 'ผ้าเสื้อ',  # นี่คือ "ผ้า" ไม่ใช่ "ผำ"
            
            # กลุ่ม "ร"
            'ราคา': 'ราคา',  # ถูกต้องแล้ว
            'รามา': 'รามา',  # ชื่อเฉพาะ
            'ระบา': 'ระบำ',  # ระบำ
            ...
            'สาเภา': 'สำเภา',
            'สาปะหลัง': 'สำปะหลัง',
            'สาลี': 'สาลี',  # ข้าวสาลี - ถูกต้องแล้ว
            ...
            # กลุ่มคำที่ขึ้นต้นด้วย "คำ" (มากที่สุด)
            'คานำ': 'คำนำ',
            'คาสั่ง': 'คำสั่ง',
            'คาแนะนำ': 'คำแนะนำ',
            'คาขอ': 'คำขอ',
        ...
        # ==========================================
        # 🔍 Pattern-based fixing (ใช้ regex) - เพิ่มเติม
        # ==========================================
        
        common_patterns = [
            # กลุ่ม จ
            (r'จา(นวน|เป็น|แนก|กัด|หน่าย|ลอง|เลย)', r'จำ\1'),
            # กลุ่ม ก
            (r'กา(หนด|ลัง|ไร|เนิด|จัด|พร้า)', r'กำ\1'),
            # กลุ่ม ช
            (r'ชา(ระ|นาญ|เรา)', r'ชำ\1'),
            # กลุ่ม ด
            (r'ดา(เนิน|เนินการ|รง|ริ)', r'ดำ\1'),
            # กลุ่ม ต
            (r'ตา(แหน่ง|รวจ|บล|หนิ)', r'ตำ\1'),
            # กลุ่ม น
            (r'นา(เสนอ|มา|ไป|ส่ง|เข้า|ออก)', r'นำ\1'),
            # กลุ่ม ล
            (r'ลา(พัง|ดับ|บาก|เลียง)', r'ลำ\1'),
            # กลุ่ม ส
            (r'สา(คัญ|หรับ|เนา|เร็จ|นัก|นวน|รวจ|แดง|เนียง|เภา)', r'สำ\1'),
            # กลุ่ม อ
            (r'อา(พัน|พราง|นาจ|นวย|เภอ)', r'อำ\1'),
            # กลุ่ม คำ (จับทุกคำ)
            (r'คา([นสขรตพแอเชบปวอกถ][ก-๙]*)', r'คำ\1'),
            # กลุ่ม ทำ
            (r'ทา(การ|งาน|ให้|ได้|ความ|ลาย|เนียบ|เป็น|ไว้|แล้ว)', r'ทำ\1'),
            # กลุ่ม ความ
            (r'ความสา(คัญ|เร็จ)', r'ความสำ\1'),
            (r'ความจา(เป็น)', r'ความจำ\1'),
        ]
